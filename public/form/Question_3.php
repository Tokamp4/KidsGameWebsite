...
<body>
    ...
    <form method="post" action="">
        <p>Question: Who wrote the "Harry Potter" book series?</p>
        <input type="radio" name="answer" value="A"> A) J.R.R. Tolkien<br>
        <input type="radio" name="answer" value="B"> B) J.K. Rowling<br>
        <input type="radio" name="answer" value="C"> C) Stephenie Meyer<br><br>
    ...
    if(isset($_POST['submit'])){
        ...
        if($user_answer == $correct_answer){
            ...
            echo '<a href="Question_4.php">Next Question</a>';
        } else {
